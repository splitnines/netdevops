...
from test_suites.test_scripts.ntp.verify_ntp import TestNtpAssociationsReach
...
#
# subclass the test classes to run them here
#
class TestEigrpV6Interfaces(TestEigrpV6Interfaces):
    pass


class TestNtpAssociationsReach(TestNtpAssociationsReach):
    pass


testcases = [
    TestEigrpV6Interfaces,
    TestNtpAssociationsReach,
]
