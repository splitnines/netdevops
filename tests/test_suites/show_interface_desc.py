...
from test_suites.test_scripts.interface.interface_desc import (
    TestShowInterfaceDesc,
)
...
class Setup(aetest.CommonSetup):
    ...
    def loop_mark(self, testbed):
        for testcase in testcases:
            aetest.loop.mark(testcase, device_name=list(testbed.devices))


# subclass all test cases that need to be run
class TestShowOInterfaceDesc(TestShowInterfaceDesc):
    pass
